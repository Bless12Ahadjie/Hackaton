...
<div className='signup-wrapper'>
        <div>
            ...
            <p className='first-txt'>Already have an account? <Link className='sign-in'>Sign In</Link></p>
        </div>
        ...
        <input className='input-signup' type="text" name="" id="" placeholder='Confirm Password'/>
